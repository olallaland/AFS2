...
//		}
		...
		if(fileSet.containsKey(id)) {
			...
			try {
				...
				//System.out.println("create file in server" + getStringFMId() +  ", and fileMeta is: " + fileMeta.toString());
	 ...
	 */
	@Override
	public void updateFile(IFileMeta fileMeta) throws RemoteException {
